...
# Goal
Write a program that returns the numbers from 1 to 100. But for multiples of three print "Fizz" instead of the number and for the multiples of five print "Buzz". For numbers which are multiples of fifteen print "FizzBuzz".
